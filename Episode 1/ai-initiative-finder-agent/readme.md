# company-ai-initiative-finder-agent
...
2. Fork the commad agent in your workspace

https://command.new/arre-ankit76795/company-ai-initiative-finder-agent
...
```env
# Get API key from your forked agent
...
```env
# Get API key from the api tab of your forked command agent
LANGBASE_API_KEY=your_langbase_api_key_here
